...
/**
 * Options for the DOCX to PDF conversion endpoint.
 * Composes: FileInput + BaseOptions
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class DocxToPdfOptions {
    ...
    private DocxToPdfOptions(Builder b) {
        this.file = b.file;
    ...
    public static final class Builder {
        ...
        public DocxToPdfOptions build() { return new DocxToPdfOptions(this); }
    }
}
