...
/**
 * Options for the Template to PDF conversion endpoint.
 * Composes: TemplateOptions + PdfOptions + PuppeteerOptions + BaseOptions
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class TemplateToPdfOptions {
    ...
    // BaseOptions (name is shared with TemplateOptions)
    ...
    private TemplateToPdfOptions(Builder b) {
    ...
    public static final class Builder {
        ...
        public TemplateToPdfOptions build() { return new TemplateToPdfOptions(this); }
    }
}
