...
/**
 * Options for the PDF to DOCX conversion endpoint.
 * Composes: FileInput + BaseOptions
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class PdfToDocxOptions {
    ...
    private PdfToDocxOptions(Builder b) {
        this.file = b.file;
    ...
    public static final class Builder {
        ...
        public PdfToDocxOptions build() { return new PdfToDocxOptions(this); }
    }
}
