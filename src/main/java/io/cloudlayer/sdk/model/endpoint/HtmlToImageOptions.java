...
/**
 * Options for the HTML to Image conversion endpoint.
 * Composes: HtmlOptions + ImageOptions + PuppeteerOptions + BaseOptions
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class HtmlToImageOptions {
    ...
    private HtmlToImageOptions(Builder b) {
        this.html = b.html;
    ...
    public static final class Builder {
        ...
        public HtmlToImageOptions build() { return new HtmlToImageOptions(this); }
    }
}
